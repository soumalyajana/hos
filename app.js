  ...
  hospitals.forEach((hospital, index) => {
    const row = `
      <tr>
        ...
        <td>
          <button class="edit-btn" onclick="editHospital('${hospital._id}')">Edit</button>
          <button class="delete-btn" onclick="deleteHospital('${hospital._id}')">Delete</button>
        </td>
      </tr>
    `;
...
// Function to logout
function logout() {
  // Hide admin panel and show login page again
